...
uimenu(ParentMenu, 'label', 'ERP Image Batch Tool', 'callback', ...
    'pop_erpimage_mg(EEG);');
	
uimenu(ParentMenu, 'label', 'AutoBatch', 'callback', ...
    ['[EEG com] = pop_AutoBatch(EEG);;EEG = eegh(com, EEG);;' ...
...
Export0 = uimenu (ParentMenu, 'label', 'Export Data','separator', 'on');
        ...
        sLORETA0 = uimenu (Export0, 'label', 'to sLORETA','callback', ...
            ['[EEG com]= pop_eeglab2sloreta(EEG);;EEG = eegh(com, EEG);;[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG, CURRENTSET);']);
